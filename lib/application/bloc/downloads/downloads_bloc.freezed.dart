...
class _DownloadsState extends DownloadsState {
  const _DownloadsState({required this.isLoading, required final  List<Downloads> downloads, required this.downloadsFailureorSuccessoption}): _downloads = downloads,super._();
